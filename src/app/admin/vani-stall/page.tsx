...
export default async function AdminPage({
  ...
  const adminPin = process.env.VANI_STALL_ADMIN_PIN || "2222";
...
const parkingSummaryMessage = buildParkingSummaryMessage({
  ...
  rows,
  activeSadhaks,
  title: "Vani Ji Stall Attendance Summary",
});
      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-3xl bg-white p-6 shadow">
          ...
          <div className="mt-1 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            ...
            Vani Ji Stall Attendance Admin
</h1>
            ...
            <a
              href={`/vani-stall?adminBack=${adminPin}`}
...
<ManageSadhaks department="Vani Ji Stall" adminPin={adminPin} />
        </div>

        <div className="mt-6">
  <CopyWhatsAppSummary
    title="Vani Ji Stall WhatsApp Message"
