...
export default function AttendancePage() {
  ...
  const [department, setDepartment] = useState<"Diksha" | "Parking">("Diksha");
  ...
  async function submitAttendance() {
    if (!department) {
      setStatus({
        type: "error",
        message: "Kripya department select karein.",
      });
      return;
    }
      ...
      <div className="mx-auto max-w-md rounded-3xl bg-white p-6 shadow-xl">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-2 text-3xl font-bold">
            Seva Team Attendance
          </h1>
          <p className="mt-2 text-sm text-zinc-600">
            Pehle department select karein. Attendance mark karne ke liye
            location permission allow karna zaroori hai.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-5">
          <label className="block">
            ...
            <select
              value={department}
              onChange={(event) =>
                setDepartment(event.target.value as "Diksha" | "Parking")
              }
